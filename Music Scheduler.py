...
def save_urls():
    for day, data in urls.items():
        ...
        if url:
            ...
            schedule_song_playback(day, "11:25", url, data['loop'].get())
...
test_button = ttk.Button(test_frame, text="Play Test Song", command=play_test_song)
test_button.grid(row=2, column=0, padx=5, pady=5, sticky='w')
